(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["stories-stories-module"], {
    ...
    /***/
    function iRj(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "StoriesStore", function () {
        return StoriesStore;
      });
      /* harmony import */
      ...
      var StoriesStore = /*#__PURE__*/function (_datorama_akita__WEBP) {
        _inherits(StoriesStore, _datorama_akita__WEBP);

        var _super = _createSuper(StoriesStore);

        function StoriesStore() {
          _classCallCheck(this, StoriesStore);

          return _super.call(this, initialState);
        }

        return StoriesStore;
      }(_datorama_akita__WEBPACK_IMPORTED_MODULE_2__["EntityStore"]);

      StoriesStore.ɵfac = function StoriesStore_Factory(t) {
        return new (t || StoriesStore)();
      };

      StoriesStore.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
        token: StoriesStore,
        factory: StoriesStore.ɵfac,
        providedIn: 'root'
      });
      StoriesStore = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_datorama_akita__WEBPACK_IMPORTED_MODULE_2__["StoreConfig"])({
        name: 'stories'
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], StoriesStore);
      /*@__PURE__*/

      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](StoriesStore, [{
    ...
    function bR(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "StoriesService", function () {
      ...
      var _stories_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./stories.store */
      "8iRj");
      /* harmony import */
      ...
      var StoriesService = /*#__PURE__*/function () {
        function StoriesService(storiesStore) {
        ...
        _createClass(StoriesService, [{
          key: "add",
          value: function add(story) {
            var _this = this;

            this.storiesStore.setLoading(true);
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["timer"])(1000).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["mapTo"])(story)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (story) {
              _this.storiesStore.setLoading(false);

              _this.storiesStore.add(story);
            }));
          }
        }]);
      ...
      StoriesService.ɵfac = function StoriesService_Factory(t) {
        return new (t || StoriesService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_stories_store__WEBPACK_IMPORTED_MODULE_1__["StoriesStore"]));
      };

      StoriesService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](StoriesService, [{
          ...
          return [{
            type: _stories_store__WEBPACK_IMPORTED_MODULE_1__["StoriesStore"]
          }];
        }, null);
      })();
      /***/
    ...
    /***/
    function Givw(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "StoriesQuery", function () {
        return StoriesQuery;
      });
      /* harmony import */
      ...
      var StoriesQuery = /*#__PURE__*/function (_datorama_akita__WEBP2) {
        _inherits(StoriesQuery, _datorama_akita__WEBP2);

        var _super2 = _createSuper(StoriesQuery);

        function StoriesQuery(store) {
          var _this2;

          _classCallCheck(this, StoriesQuery);
      ...
      StoriesQuery.ɵfac = function StoriesQuery_Factory(t) {
        return new (t || StoriesQuery)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_stories_store__WEBPACK_IMPORTED_MODULE_1__["StoriesStore"]));
      };

      StoriesQuery.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
        token: StoriesQuery,
        factory: StoriesQuery.ɵfac,
        providedIn: 'root'
      });
      /*@__PURE__*/

      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](StoriesQuery, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
          args: [{
            providedIn: 'root'
          }]
    ...
    /***/
    function XwQj(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "createStory", function () {
        return createStory;
      });
    ...
    /***/
    function bnrc(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "StoriesModule", function () {
      ...
      var _stories_stories_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var StoriesModule = function StoriesModule() {
        _classCallCheck(this, StoriesModule);
      };

      StoriesModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: StoriesModule
      });
      StoriesModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function StoriesModule_Factory(t) {
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](StoriesModule, {
          declarations: [_stories_stories_component__WEBPACK_IMPORTED_MODULE_2__["StoriesComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"]]
        });
      })();
      /*@__PURE__*/
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](StoriesModule, [{
    ...
    /***/
    function tc2K(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _state_stories_query__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ../state/stories.query */
      "Givw");
      /* harmony import */


      var _state_story_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../state/story.model */
      "XwQj");
      /* harmony import */


      var _state_stories_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../state/stories.service */
      "93bR");
      /* harmony import */
      ...
      function StoriesComponent_div_58_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var StoriesComponent = /*#__PURE__*/function () {
        function StoriesComponent(storiesQuery, storiesService, builder) {
        ...
        _createClass(StoriesComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.storeValue = this.storiesQuery.select(function (state) {
              return state.akitaForm;
            });
          }
        }, {
          key: "submit",
          value: function submit() {
            ...
            this.storiesService.add(this.form.value).subscribe(function () {
              return _this3.persistForm.reset();
            });
      ...
      StoriesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function StoriesComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function StoriesComponent_Template_button_click_11_listener() {
              return ctx.addSkill();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function StoriesComponent_Template_form_ngSubmit_19_listener() {
              return ctx.submit();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function StoriesComponent_Template_form_ngSubmit_33_listener() {
              return ctx.submit();
            });
        ...
        pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_6__["JsonPipe"], _angular_common__WEBPACK_IMPORTED_MODULE_6__["AsyncPipe"]],
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](StoriesComponent, [{
          ...
          return [{
            type: _state_stories_query__WEBPACK_IMPORTED_MODULE_3__["StoriesQuery"]
          }, {
            type: _state_stories_service__WEBPACK_IMPORTED_MODULE_5__["StoriesService"]
          }, {
...
//# sourceMappingURL=stories-stories-module-es5.js.map